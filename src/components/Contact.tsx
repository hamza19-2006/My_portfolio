        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          >
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              I am active on WhatsApp, email, and LinkedIn. For quick requirements scoping or urgent architectural questions, WhatsApp provides the fastest direct turnaround.
            </p>
            ...
            <div className="space-y-3">
              ...
              <a
                ...
                className="glass-card rounded-2xl p-4 flex items-center justify-between hover:border-emerald-500/40 hover:bg-white/[0.04] transition-all group"
              >
              ...
              <a
                ...
                className="glass-card rounded-2xl p-4 flex items-center justify-between hover:border-blue-500/40 hover:bg-white/[0.04] transition-all group"
              >
                <div className="flex items-center gap-3.5">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="glass-card rounded-2xl p-4 flex items-center justify-between hover:border-sky-500/40 hover:bg-white/[0.04] transition-all group"
              >
                <div className="flex items-center gap-3.5">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="glass-card rounded-2xl p-4 flex items-center justify-between hover:border-zinc-400/40 hover:bg-white/[0.04] transition-all group"
              >
                <div className="flex items-center gap-3.5">
                  <div className="w-11 h-11 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-zinc-200 group-hover:scale-105 transition-transform">
          ...
          >
            <div className="glass-panel rounded-3xl p-6 sm:p-10 border border-white/10 shadow-2xl">
              ...
              <p className="text-xs sm:text-sm text-zinc-400 mb-6">
                Tell me about your project, integration, or architecture scope and I will reply within 24 hours.
              </p>
              ...
              {isSubmitted ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-4 px-5 py-2.5 rounded-xl bg-white/10 text-white text-xs font-semibold hover:bg-white/20 transition-all cursor-pointer"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      <option value="n8n Workflow Automation">n8n Workflow Automation Pipeline</option>
                      <option value="AI Assistant or Integration">Autonomous LLM Agent / Tool Integration</option>
                      <option value="Web Application or Landing Page">Full-Stack Web Platform (React/Next.js)</option>
                      <option value="Mobile App Development">Mobile App (Flutter / Dart)</option>
                      <option value="CRM and API Integration">CRM & API Integration (WhatsApp, GHL, Stripe)</option>
                      <option value="Consulting or Workflow Audit">Workflow Performance & Architecture Audit</option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Outline what manual processes you are looking to automate, systems involved, or timeline..."
                  ...
                  <button
                    ...
                    className="w-full py-4 rounded-xl bg-white hover:bg-zinc-100 disabled:opacity-50 text-zinc-950 font-bold text-sm tracking-wide shadow-lg transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-98"
                  >
                    {isSubmitting ? (
                      <>
